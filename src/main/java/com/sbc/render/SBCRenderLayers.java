...
public class SBCRenderLayers {
	...
	public static final MultiPhase FILLED_THROUGH_WALLS = RenderLayer.of("filled_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, SBCRenderPipelines.FILLED_THROUGH_WALLS, MultiPhaseParameters.builder()
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));
	...
	private static final DoubleFunction<MultiPhase> LINES_THROUGH_WALLS = lineWidth -> RenderLayer.of("lines_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, false, SBCRenderPipelines.LINES_THROUGH_WALLS, MultiPhaseParameters.builder()
			.lineWidth(new LineWidth(OptionalDouble.of(lineWidth)))
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));
	...
	public static final MultiPhase QUADS_THROUGH_WALLS = RenderLayer.of("quad_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, SBCRenderPipelines.QUADS_THROUGH_WALLS, MultiPhaseParameters.builder()
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));

	private static final Function<Identifier, MultiPhase> TEXTURE = texture -> RenderLayer.of("texture", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, SBCRenderPipelines.TEXTURE, MultiPhaseParameters.builder()
			.texture(new RenderPhase.Texture(texture, TriState.FALSE, false))
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));

	private static final Function<Identifier, MultiPhase> TEXTURE_THROUGH_WALLS = texture -> RenderLayer.of("texture_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, SBCRenderPipelines.TEXTURE_THROUGH_WALLS, MultiPhaseParameters.builder()
			.texture(new RenderPhase.Texture(texture, TriState.FALSE, false))
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));
	public static final MultiPhase CYLINDER = RenderLayer.of("cylinder", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, SBCRenderPipelines.CYLINDER, MultiPhaseParameters.builder()
			.layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
			.build(false));
