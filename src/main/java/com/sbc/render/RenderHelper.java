...
public class RenderHelper {
    ...
    public static void renderFilled(WorldRenderContext context, Coordinate pos, Color color, boolean throughWalls) {
        renderFilledInternal(context, pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1, color.getR(), color.getG(), color.getB(), color.getA(), throughWalls);
    }
    
    public static void renderFilled(WorldRenderContext context, Coordinate pos1, Coordinate pos2, Color color, boolean throughWalls) {
        renderFilledInternal(context, pos1.getX(), pos1.getY(), pos1.getZ(), pos2.getX(), pos2.getY(), pos2.getZ(), color.getR(), color.getG(), color.getB(), color.getA(), throughWalls);
    } 
    ...
    public static void renderOutline(WorldRenderContext context, Coordinate pos, Color color, float lineWidth, boolean throughWalls) {
        renderOutlineInternal(context, pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1, color.getR(), color.getG(), color.getB(), color.getA(), lineWidth, throughWalls);
    }

    public static void renderOutline(WorldRenderContext context, Coordinate pos1, Coordinate pos2, Color color, float lineWidth, boolean throughWalls) {
